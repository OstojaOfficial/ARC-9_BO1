...
SWEP.ViewModel = "models/weapons/arc9/c_waw_arisaka.mdl"
SWEP.WorldModel = "models/weapons/arc9/w_waw_arisaka.mdl"
SWEP.WorldModelMirror = "models/weapons/arc9/w_waw_arisaka.mdl"
...
SWEP.ShootSound = "ARC9_WAW.Arisaka_Fire"
...
SWEP.IronSights = {
    Pos = Vector(-1.2, -5, 1.15),
    Ang = Angle(-0.085, -0.65, 0),
    Magnification = 1.5,
    ViewModelFOV = 50,
...
SWEP.Hook_ModifyBodygroups = function(self, data)
    ...
    if attached["arisaka_scope"] then
        vm:SetBodygroup(1,2)
    end
    vm:SetSkin(camo)
...
SWEP.Animations = {
    ...
    ["fire"] = {
        Source = {"fire"},
        Time = 7 / 30,
        {s = "ARC9_WAW.Arisaka_Mech", t = 0 / 30},
    },
    ["cycle"] = {
        Source = {"cycle"},
        Time = 28 / 30,
    ...
    ["fire_iron"] = {
        Source = {"fire_ads"},
        Time = 7 / 30,
        {s = "ARC9_WAW.Arisaka_Mech", t = 1 / 30},
    },
    ["cycle_ads"] = {
        Source = {"cycle_ads"},
        Time = 28 / 30,
    ...
    ["cycle_scope"] = {
        ...
        EventTable = {
            ...
            {s = "ARC9_WAW.Arisaka_Back", t = 10 / 30},
            {s = "ARC9_WAW.Arisaka_Fwd", t = 20 / 30},
            {s = "ARC9_WAW.Arisaka_Down", t = 25 / 30},
        },
    },
    ["fire_iron_scope"] = {
        Source = {"fire_scope"},
