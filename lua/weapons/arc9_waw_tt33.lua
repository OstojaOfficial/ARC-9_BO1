...
SWEP.ViewModel = "models/weapons/arc9/c_waw_tt33.mdl"
SWEP.WorldModel = "models/weapons/arc9/c_waw_tt33.mdl"
...
SWEP.IronSights = {
    Pos = Vector(-3.05, -2, 1.9),
    Ang = Angle(-0.075, 0.2, 0),
    ViewModelFOV = 60,
    Magnification = 1.1,
    --AssociatedSlot = 9,
